...
def download_playlist(playlist_url, download_type):
    ...
    if not ffmpeg_path:
        print("⚠️  FFmpeg not found! Please install or place it in ./ffmpeg/bin/")
        sys.exit(1)
    else:
        print(f"🎞️ Using FFmpeg from: {ffmpeg_path}\n")
    ...
    print(f"📁 Files will be saved in: {folder}\n")
...
def main():
    ...
    print("🎬 YouTube Playlist Downloader 🎧 (Final with Folders & Quality)")
